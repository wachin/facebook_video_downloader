...
>
> 📖 **[README in English (English version)](README.md)**
...
3. Entra a una colección de tus guardados. Abajo a la derecha verás un panel
   ...
   - **«📥 Enviar vídeos visibles»** — envía solo los vídeos que se ven en
     pantalla.
   - **«↩ Cerrar Facebook»** — cierra la ventana de Facebook; Facebook Collections Downloader
     sigue abierto.
4. Verás un aviso verde al empezar la descarga. Su **progreso se ve en vivo**
   en la ventana de Facebook Collections Downloader: la pestaña **Facebook** muestra la lista por
...
2. Deja los archivos en la carpeta de vídeos de la app (por defecto
   `~/Videos/Recetas`).
3. Abre Facebook Collections Downloader, pulsa **Escanear** y el vídeo aparece en la Biblioteca.
...
Se abrirá la ventana de **Facebook Collections Downloader**. 🎉
...
- **Facebook**: se abre en una **ventana propia** (Facebook Collections Downloader sigue abierto),
...
> **La idea arquitectónica en una frase:** Facebook Collections Downloader es una aplicación
